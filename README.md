...
<table><tr>
    ...
    <td>
      <a href="https://github.com/conda-forge/aws-c-sdkutils-feedstock/actions/workflows/conda-build.yml">
        <img src="https://github.com/conda-forge/aws-c-sdkutils-feedstock/actions/workflows/conda-build.yml/badge.svg?event=push&branch=main">
      </a>
    </td>
  </tr>
...
pixi add aws-c-sdkutils
# for installing globally
pixi global install aws-c-sdkutils
```
...
It is possible to list all of the versions of `aws-c-sdkutils` available on your platform:
...
```
pixi search aws-c-sdkutils --channel conda-forge
```
